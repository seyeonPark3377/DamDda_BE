...
//    private String thumbnailUrl; // 이미지-사진5장이랑 설명이미지 같이 들어있을듯
    ...
    private List<String> docs; // 이미지-사진5장이랑 설명이미지 같이 들어있을듯
//    private List<String> reqDocs; // 이미지-사진5장이랑 설명이미지 같이 들어있을듯
//    private List<String> certDocs; // 이미지-사진5장이랑 설명이미지 같이 들어있을듯
