...
VALUES 
(1, '메이크업 기본 패키지', '5000', 500, 55),
(2, '피부 관리 완벽 세트', '15000', 400, 0),
(3, '뷰티 트렌드 인사이더 패키지', '20000', 200, 2),
(4, '프로 메이크업 아티스트 키트', '25000', 400, 18),
(5, '헤어스타일 변신 패키지', '12000', 300, 0),
(6, '스킨케어 풀 패키지', '18000', 300, 135),
(7, '뷰티 비즈니스 인사이트 패키지', '30000', 400, 75),
(8, '뷰티 크리에이터 스타터 팩', '22000', 200, 132),
(9, '글로벌 뷰티 마스터 세트', '28000', 500, 0),
(10, '셀프 뷰티 프로 패키지', '15000', 300, 0),
(11, 'K-POP 댄스 마스터 세트', '20000', 500, 0),
(12, '아이돌 뷰티 시크릿 패키지', '18000', 200, 30),
(13, 'K-POP 퍼포먼스 완성 패키지', '25000', 300, 0),
(14, '아이돌 패션 올인원 세트', '22000', 400, 38),
(15, 'K-POP 역사 탐구 스페셜 에디션', '15000', 600, 86),
(16, '아이돌 팬미팅 VIP 패키지', '30000', 300, 0),
(17, 'K-POP 콘텐츠 크리에이터 키트', '28000', 300, 75),
(18, 'K-POP 뮤지션 체험 패키지', '35000', 300, 0),
(19, 'K-POP 안무가 도전 세트', '20000', 600, 126),
(20, '팬아트 아티스트 패키지', '15000', 100, 0),
(21, 'K-드라마 OST 컬렉터 에디션', '25000', 300, 0),
(22, '웹툰 작가 데뷔 패키지', '30000', 500, 0),
(23, 'K-드라마 제작 참여 스페셜 세트', '50000', 500, 58),
(24, 'K-영화 글로벌 팬 패키지', '20000', 200, 34),
(25, 'K-드라마 팬 ultimate 경험 세트', '40000', 600, 64),
(26, '드라마 비하인드 컬렉션 박스', '18000', 400, 0),
(27, 'K-드라마 팬 굿즈 스페셜 에디션', '15000', 200, 63),
(28, 'K-드라마 리뷰어 스타터 패키지', '22000', 500, 0),
(29, 'K-콘텐츠 박람회 VIP 경험 세트', '35000', 500, 0),
(30, 'K-영화 글로벌 프리미어 패키지', '30000', 400, 108),
(31, '김치 전문가 패키지', '10000', 400, 140),
(32, '한식 요리 클래스 패키지', '35000', 500, 80),
(33, 'K-푸드 체험 패키지', '12000', 300, 38),
(35, '한식 디저트 패키지', '28000', 300, 99),
(36, '한식 요리 연구 패키지', '10000', 600, 88),
(38, '한식 배달 패키지', '10000', 600, 35),
(39, '한식 셰프 클래스 패키지', '10000', 700, 138),
(43, '전통 음악 패키지', '35000', 600, 145),
(44, '문화재 보호 캠페인 패키지', '10000', 300, 115),
(45, '전통 공예 패키지', '28000', 500, 137),
(47, '전통 의상 제작 패키지', '10000', 500, 113),
(48, '전통 음식 복원 패키지', '28000', 300, 47),
(51, '한복 패션쇼 패키지', '12000', 500, 124),
(52, 'K-패션 브랜드 패키지', '10000', 300, 119),
(53, '전통 의상 디자인 패키지', '10000', 500, 99),
(54, 'K-뷰티 패션 콜라보 패키지', '12000', 600, 138),
(56, 'K-패션 팝업 패키지', '12000', 600, 96),
(57, '전통 패션 교육 패키지', '10000', 600, 134),
(60, '한복 리메이크 패키지', '35000', 200, 15),
(61, '전통 게임 개발 패키지', '20000', 500, 91),
(65, 'K-게임 스토리 패키지', '10000', 600, 44),
(67, 'K-게임 OST 패키지', '10000', 200, 9),
(69, 'K-게임 컨퍼런스 패키지', '20000', 400, 83);
