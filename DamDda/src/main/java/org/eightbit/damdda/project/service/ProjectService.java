...
//    public List<Project> getProjectsByIds(List<Long> projectIds);
    ...
    Long register(ProjectDetailDTO projectDetailDTO, boolean submit, List<MultipartFile> images);
    Project findById(Long id);
    Long updateProject(ProjectDetailDTO projectDetailDTO, Long projectId, boolean submit, List<MultipartFile> images);
}
